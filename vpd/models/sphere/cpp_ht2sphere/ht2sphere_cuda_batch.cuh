...
{
  // launch batch*num_pts*num_votes*channel  cores
...
{
  const int num_kernels = batch*num_pts*num_votes*num_pts;
                  ...
                  )
{
  ...
  const int num_kernels = batch*num_pts*num_votes*channel;
  // ***********************************************************************//
