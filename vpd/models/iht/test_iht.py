...
from neurvps.models.iht.iht_torch import IHT_TORCH
from neurvps.models.iht.iht_cuda import IHT_CUDA
...
model =[]
model.append(IHT_CUDA(vote_index_dict))
...
for p in range(0,100):
    print('p:', p)
    test_in = torch.randn(batch, channel, h, w).float()
    ...
    print('test_grad', test_in.grad.shape)
