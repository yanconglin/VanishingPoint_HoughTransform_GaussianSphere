...
In this repository, the details (Pixels - HT -Gaussian Sphere) are:<br/>
SU3: 256x256 - 365x180 - 32768; (precise VPs)<br/>
ScanNet: 256x256 - 365x180 - 16384; (coarse VPs only, 128x128 - 384x180 - 16384 already good enough)<br/>
